...
- [ ] Add `public/images/vallarta-wknd.jpg` (1600 px wide, 16:10) and set it in `constants/projects.const.ts` (see IMPROVEMENTS #1).
...
- [ ] Replace `PORTFOLIO_YEAR` in `constants/profile.const.ts` when the year changes.
